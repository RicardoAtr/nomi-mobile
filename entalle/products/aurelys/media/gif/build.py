...
def comp(base,a,sq):
    ...
    return b
for sq,name,size in [(False,'aurelys-2x1-9x16.mp4',(1080,1920)),(True,'aurelys-2x1-1x1.mp4',(1080,1080))]:
...
fr[0].save('aurelys-2x1-9x16.gif',save_all=True,append_images=fr[1:],duration=50,loop=0,optimize=True)
fq=[comp(f,a,True).resize((720,720),Image.LANCZOS) for f,a in seq(20)]
fq[0].save('aurelys-2x1-1x1.webp',save_all=True,append_images=fq[1:],duration=50,loop=0,quality=80,method=4)
