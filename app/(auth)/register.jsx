...
const s = StyleSheet.create({
  ...
  logoText:  { color: '#fff', fontSize: 28, fontFamily: 'Jakarta-Bold' },
  brand:     { fontSize: 28, fontFamily: 'Jakarta-Bold', color: COLORS.text, letterSpacing: -0.5 },
  slogan:    { fontSize: 14, fontFamily: 'Jakarta-Regular', color: COLORS.textSub, marginTop: 4, fontStyle: 'italic' },
  card:      { backgroundColor: COLORS.white, borderRadius: 20, padding: 24,
               shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 12, elevation: 3 },
  title:     { fontSize: 18, fontFamily: 'Jakarta-SemiBold', color: COLORS.text, marginBottom: 20 },
  label:     { fontSize: 12, fontFamily: 'Jakarta-Medium', color: COLORS.textSub, marginBottom: 6 },
  input:     { borderWidth: 1, borderColor: COLORS.border, borderRadius: 12, padding: 14,
               fontSize: 15, fontFamily: 'Jakarta-Regular', color: COLORS.text, marginBottom: 16, backgroundColor: COLORS.bg },
  btn:       { backgroundColor: COLORS.brand, borderRadius: 12, padding: 16,
               alignItems: 'center', marginTop: 4 },
  btnText:   { color: '#fff', fontSize: 15, fontFamily: 'Jakarta-SemiBold' },
  link:      { alignItems: 'center', marginTop: 20 },
  linkText:  { color: COLORS.textSub, fontSize: 14, fontFamily: 'Jakarta-Regular' },
  linkBold:  { color: COLORS.brand, fontFamily: 'Jakarta-SemiBold' },
})
